...
#
# COMMAND:
#   pypi2nix -v -C /tmp/release-services-4uqimruc/src/codecoverage/backend/../../../tmp/pypi2nix -V 3.7 -O ../../../nix/requirements_override.nix -e vcversioner -e pytest-runner -e setuptools-scm -r requirements.txt -r requirements-dev.txt
#
...
let
  ...
  generated = self: {
    ...
    "fakeredis" = python.mkDerivation {
      name = "fakeredis-1.0";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/5b/21/6f496f2abe0837f5ee92ec5b8972c5516c7a1665a2ab489bf3d2b818f879/fakeredis-1.0.tar.gz";
        sha256 = "f1254acb6ee6ebb51fa55c54dfec26b2bee4fbab6f55de0ee768216bc213d4b8";
      };
      doCheck = commonDoCheck;
      checkPhase = "";
      installCheckPhase = "";
